...
- 현재 저장소 기준 빌드: **v0.3.3.t**
- 현재 실행 파일: [`Living_Hospital_v0.3.3.t.html`](./Living_Hospital_v0.3.3.t.html)
...
6. GitHub Pages 배포 설정은 현재 사용하지 않습니다.
...
`최신 코드 확인 → 변경 계획 확정 → 작업 브랜치 생성 → 새 버전 파일 작성 → 코드 검토 → 모바일 테스트 → 문서 갱신 → main 반영`
